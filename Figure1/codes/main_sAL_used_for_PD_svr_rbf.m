...
load('~/Figure1/data/PD_data') %please add the directory to load the data here!
X_all=X;
y_all=y;
...
save('~/Figure1/results/result_PD_SVR_RBF','MSEs','CCs')   %please change this directory to avoid overwritting the shared result!
