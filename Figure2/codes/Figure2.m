...
load('~/Figure2/results/NHP_RR_S2.mat')
...
all_reg_cc=vertcat(all_reg_cc,nanmean(auc_cc_all));
all_reg_rmse=vertcat(all_reg_rmse,nanmean(auc_rmse_all));
load('~/Figure2/results/NHP_RR_S3.mat')
...
load('~/Figure2/results/NHP_RR_S4.mat')
...
load('~/Figure2/results/NHP_SVR_LIN_S2.mat')
...
all_reg_cc=vertcat(all_reg_cc,nanmean(auc_cc_all));
all_reg_rmse=vertcat(all_reg_rmse,nanmean(auc_rmse_all));
load('~/Figure2/results/NHP_SVR_LIN_S3.mat')
...
load('~/Figure2/results/NHP_SVR_LIN_S4.mat')
...
load('~/Figure2/results/NHP_SVR_RBF_S2.mat')
...
all_reg_cc=vertcat(all_reg_cc,nanmean(auc_cc_all));
all_reg_rmse=vertcat(all_reg_rmse,nanmean(auc_rmse_all));
load('~/Figure2/results/NHP_SVR_RBF_S3.mat')
...
load('~/Figure2/results/NHP_SVR_RBF_S4.mat')
...
load('~/Figure2/results/NHP_GPR_S2.mat')
...
all_reg_cc=vertcat(all_reg_cc,nanmean(auc_cc_all));
all_reg_rmse=vertcat(all_reg_rmse,nanmean(auc_rmse_all));
load('~/Figure2/results/NHP_GPR_S3.mat')
...
load('~/Figure2/results/NHP_GPR_S4.mat')
