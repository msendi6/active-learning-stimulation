...
load('~/Figure4/data/data_opto.mat') %please make sure you add the correct directory here
dataU=data;    
...
save('~/Figure4/results/Opto_SVR_RBF','MSEs','CCs')  %please change this directory to avoid overwritting the shared result!
