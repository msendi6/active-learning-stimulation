...
load('~/Figure3/data/brain_state_data.mat')
dataU=data;
X_all=dataU(:,1:4); y_all=dataU(:,5);
pool_train_n=79;
test_n=20;
warning off
%%
...
save('~/Figure3/results/NHP_SVR_RBF_brain_state_dynamic','MSEs','CCs')%please change the name to avoid overwritting the shared results
