classdef opto_stimulator_3_sine < handle
...
%                         size(obj.stimulation_channels,1));
                ...
                case 'sinusoid'
                    signal = opto_generate_sinusoid_stim(obj.sampling_frequency, ...
                        obj.stimulation_duration, ...
                        obj.stimulation_N_sinusoid, ...
                        obj.stimulation_amplitude, ...
                        obj.stimulation_frequency);
                
                case 'train'
                    signal = opto_generate_nested_train(obj.sampling_frequency,       ...
...
%             log_string = [log_string sprintf('%f,', obj.stimulation_N_sinusoid)];
            ...
            if strcmp(obj.stimulation_type,'sequence')
                ...
                log_string = [log_string sprintf('%f,', obj.stimulation_amplitude)];
                log_string = [log_string sprintf('%f,', obj.stimulation_amplitude)];
            end
            log_string = [log_string sprintf('%f,', obj.stimulation_pulse_width_train)];
            log_string = [log_string sprintf('%f,', obj.stimulation_pulse_width_train)];
            log_string = [log_string sprintf('%f,', obj.stimulation_pulse_width_pulse)];
            log_string = [log_string sprintf('%f,', obj.stimulation_pulse_width_pulse)];
        ...
        function log_stimulation_sine(obj)
            obj.stimulation_uid     = posixtime(datetime('now'));
            log_string = '';
            log_string = [log_string sprintf('%f,', obj.stimulation_uid)];
            log_string = [log_string sprintf('%s,', obj.headstage_type)];
            ...
            log_string = [log_string sprintf('%f,', obj.stimulation_frequency(1))];
            if length(obj.stimulation_frequency) == 1
                log_string = [log_string sprintf('%f,', 0)]; log_string = [log_string sprintf('%f,', 0)];
            elseif length(obj.stimulation_frequency) == 2
                log_string = [log_string sprintf('%f,', obj.stimulation_frequency(2))]; log_string = [log_string sprintf('%f,', 0)];
            else
                log_string = [log_string sprintf('%f,', obj.stimulation_frequency(2))]; log_string = [log_string sprintf('%f,', obj.stimulation_frequency(3))];
            end
            log_string = [log_string sprintf('%f,', obj.stimulation_duration)];
            
            log_string = [log_string sprintf('%f,', obj.stimulation_amplitude(1))];
            if length(obj.stimulation_frequency) == 1
                log_string = [log_string sprintf('%f,', 0)]; log_string = [log_string sprintf('%f,', 0)];
            elseif length(obj.stimulation_frequency) == 2
                log_string = [log_string sprintf('%f,', obj.stimulation_amplitude(2))]; log_string = [log_string sprintf('%f,', 0)];
            else
                log_string = [log_string sprintf('%f,', obj.stimulation_amplitude(2))]; log_string = [log_string sprintf('%f,', obj.stimulation_amplitude(3))];
            end
            ...
            if strcmp(obj.stimulation_type,'sequence')
                ...
                switch obj.display_log_output
                    ...
                    case 'verbose'
                        fprintf(log_string);
                    case 'simple'
                        if obj.stimulation_N_sinusoid == 1
                        fprintf('\nFrequency_1: %.1f, Duration: %.2f, Amplitude: %.2f\n', ...
                            obj.stimulation_frequency(1), obj.stimulation_duration,...
                            obj.stimulation_amplitude);
                        elseif obj.stimulation_N_sinusoid == 2
                            fprintf('\nFrequency_1: %.1f, Frequency_2: %.1f, Duration: %.2f, Amplitude: %.2f, Ratio: %.2f\n', ...
                            obj.stimulation_frequency(1), obj.stimulation_frequency(2), ...
                            obj.stimulation_duration, obj.stimulation_amplitude(1), ...
                            obj.stimulation_amplitude(2));
                        end
                end
            end
            fprintf(obj.stimulation_fid, log_string);
        ...
        function write_log_header(obj)
            if strcmp(obj.stimulation_type,'sinusoid')
              header_string = ['stimulation_uid,' ...
                ...
                'stimulation_time,' ...
                'N_sinusoid,' ...
                'stimulation_frequency_a,' ...
                'stimulation_frequency_b,' ...
                'stimulation_frequency_c,' ...
                'stimulation_duration,' ...
                'stimulation_amplitude_a,' ...
                'stimulation_amplitude_b,' ...
                'stimulation_amplitude_c,' ...
