...
% EXPERIMENT_TYPE = 'gp_gamma_uncertainty_sampling_2'; %active learning of gamma response vs. standard train param
% EXPERIMENT_TYPE = 'nested_random_search'; %Code by eric to do random grid of NPT parameters
% EXPERIMENT_TYPE = 'nested_grid_search';
...
% EXPERIMENT_TYPE = 'grid_search_seizure';
