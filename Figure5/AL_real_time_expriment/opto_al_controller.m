...
%             obj.stimulator.check_stimulation()
        ...
        function select_next_sample(obj)
            ...
            if obj.n_samples <= obj.n_burn_in
                ...
                obj.parameter_vector(obj.n_samples,:) = active_learning_function(obj.param_space,...
                    obj.parameter_vector(1:obj.n_samples,:),obj.sample_results(1:obj.n_samples),...
